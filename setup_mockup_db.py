...
def generate_student_data():
    ...
    for name in names:
        ...
        # Add Data To List
        student_data.append({"name": name, "email_address": email_address, "id": student_id})
...
def fill_tables_with_data(cursor, student_data, num_sessions, num_teams):
    for session_id in range(num_sessions):
        ...
        for team_id in range(num_teams):
            ...
            cursor.execute('INSERT INTO teams VALUES(?,?,?)', (team_number, session_id, "Team " + str(team_number)))
        ...
        for student in student_data:
            ...
            for team_index in range(num_teams):
                ...
                #   start = 40, start + team_offset_id = 40 + 1 = 41, which is the index of the first
                #   student on the second team (in the current session).
                #   team_id_offset is calculated by taking the student_id (before
